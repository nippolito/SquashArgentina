...
class Torneo(object):
	...
	mientras que ésta lo calcula según la cantidad de inscriptxs
...
def mostrarCatYCant(torneo):
	...
	for i in range(0, len(ct)):
		if(ct[i].modoJuego == "Zonas"):
			print( "> CAT: " + ct[i].nombre + " -- Inscriptxs:", end=" ")
			print( ct[i].cantJug, end=" ")
			print( "> Modo juego:", end=" ")
			print( ct[i].modoJuego, end=" ")
			print( "-- #Jug en llaves:", end=" "),
...
def mostrarDatos(torneo, sede):
	print( "")
	print( "La cantidad de canchas en la sede es:", end=" ")
	print( sede.canchas)

	print( "Los horarios son:", end=" ")
	print( "Jueves >", end=" ")
	print( torneo.horasJu[0], end=" ")
	print( "a", end=" ")
	print( torneo.horasJu[1], end=" ")
	print( "hs. Viernes >", end=" ")
	print( torneo.horasVi[0], end=" ")
	print( "a", end=" ")
	print( torneo.horasVi[1], end=" ")
	print( "hs. Sábado >", end=" ")
	print( torneo.horasSa[0], end=" ")
	print( "a", end=" ")
	print( torneo.horasSa[1], end=" ")
	print( "hs. Domingo >", end=" ")
	print( torneo.horasDom[0], end=" ")
	print( "a", end=" ")
	print( torneo.horasDom[1], end=" ")
	print( "hs.")

	print( "")
	print( "La cantidad de inscriptxs entre todas las categorías es:", end=" ")
	print( torneo.cantInscriptos())

	print( "La cantidad de partidos totales que pueden realizarse es:", end=" ")
	...
	print( "En total habría en el torneo", end=" ")
	print( torneo.PartTotGrupos(), end=" ")
	print( "partidos en fase de grupos.")

	print( "En total habría en el torneo", end=" ")
	print( torneo.PartTotCuadros(), end=" ")
	print( "partidos en fase de eliminación directa.")

	print( "Esto da un total de", end=" ")
	print( torneo.PartidosTotales(), end=" ")
	print( "partidos en total.")

	print( "")
	print( "Día Domingo (SF y F): Total partidos >", end=" ")
	print( torneo.DomingoCantPartTot(), end=" ")
	print( "partidos. Total de canchas >", end=" ")
